package Linked_List.LeetCode.SinglyLinkedList.RemoveDuplicates;
...
public class RemoveUsingHashSet {
    ...
    public RemoveUsingHashSet(int value) {
    ...
    public static void main(String[] args) {
        RemoveUsingHashSet myLinkedList = new RemoveUsingHashSet(1);
